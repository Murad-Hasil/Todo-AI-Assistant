...
- [x] `alternates.canonical` added to Metadata object in `layout.tsx`
...
- [x] Page matches dark theme (`bg-[#0f172a]`)
...
- [x] `/manifest.webmanifest` returns JSON
- [x] `/xyz` shows branded 404
- [x] Canonical tag present in page source
...
| Task | File | Status |
|------|------|--------|
| T001 | `layout.tsx` — canonical | [x] |
| T002 | `manifest.ts` — PWA | [x] |
| T003 | `not-found.tsx` — 404 | [x] |
| T004 | Build check | [x] |
| T005 | Git commit + push | [x] |
| T006 | Vercel deploy + verify | [x] |
